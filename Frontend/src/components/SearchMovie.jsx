    ...
    <>
      <div className="flex justify-center pt-[15%] w-[100%]">
        <form onSubmit={submitHandler} className="w-[50%]">
          <div className="flex justify-between shadow-md p-1 border-2 border-gray-200 rounded-lg w-[100%]">
            <input
              value={searchMovie}
              onChange={(e) => {
      ...
      {
        searchedMovie ? ( <MovieList title={movieName} searchMovie={true} movies={movieName.popularMovie} /> )  (<h1>Movie Not Found!!</h1>)
      }
